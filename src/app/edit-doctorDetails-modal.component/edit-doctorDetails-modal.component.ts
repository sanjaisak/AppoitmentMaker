...
@Component({
  selector: 'app-edit-doctorDetails-modal',
  templateUrl: './edit-doctorDetails-modal.component.html',
  styleUrls: ['./edit-doctorDetails-modal.component.scss'],
})
export class EditDoctorDetailsModalComponent implements OnInit {
